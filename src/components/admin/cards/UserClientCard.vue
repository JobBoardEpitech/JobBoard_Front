    ...
    <div class="flex flex-col">
      <div class="-m-1.5 overflow-x-auto">
        <div class="p-1.5 min-w-full inline-block align-middle">
          <div class="border rounded-xl shadow-sm overflow-hidden bg-slate-900 border-gray-700">
            <!-- Header -->
            <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-700">
              <div>
              ...
              <div>
                <div class="inline-flex gap-x-2">
                  <a class="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium
                  shadow-sm align-middle hover:bg-gray-50 focus:outline-none
                  transition-all text-sm
                  bg-slate-900 text-gray-400 hover:text-white" href="#">
                    View all
                  </a>
...
import UserClientList from "@/components/admin/list/UserClientList.vue";
import PaginationManager from "@/components/admin/pagination/PaginationManager.vue";
</script>